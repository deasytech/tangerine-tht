...
import { BuyNowForm } from "@/components/tht/forms/buy-now-form"
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-32">
        ...
        <div className="flex flex-col w-full gap-6 pb-16">
          <div className="space-y-6 mb-4">
            <h3 className="text-blue-950 text-5xl font-normal font-gilroy-semibold leading-10">Buy now</h3>
